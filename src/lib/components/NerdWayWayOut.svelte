<script lang="ts">
	...
	import CriteriaMatrix from './CriteriaMatrix.svelte';
...
<div class="space-y-6">
	...
	{#if criteria.length > 1}
		<div class="border-t pt-6">
			<h3 class="text-lg font-semibold mb-4">Adjust Criteria Weights</h3>
			<p class="text-sm text-gray-600 mb-4">Use the matrix to compare criteria importance and set weights.</p>
			<CriteriaMatrix 
				{criteria} 
				{onCriteriaUpdate}
			/>
